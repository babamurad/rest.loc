                ...
                <div class="col-lg-4 col-sm-8 col-md-6">
                    <div class="fp__footer_content">
                        <a class="footer_logo" href="/">
                            <img src="{{ asset($footerInfo ? $footerInfo->logo : 'assets/images/logo.png') }}" alt="FoodPark" class="img-fluid w-100">
                        </a>
                        @if(isset($footerInfo) && $footerInfo && $footerInfo->short_info)
                        <span>{{ $footerInfo->short_info }}</span>
                        @endif
                        @if(isset($footerInfo) && $footerInfo && $footerInfo->address)
                        <p class="info"><i class="far fa-map-marker-alt"></i> {{ $footerInfo->address }}</p>
                        @endif
                        @if(isset($footerInfo) && $footerInfo && $footerInfo->phone)
                        <a class="info" href="callto:{{ $footerInfo->phone }}"><i class="fas fa-phone-alt"></i>{{ $footerInfo->phone }}</a>
                        @endif
                        @if(isset($footerInfo) && $footerInfo && $footerInfo->email)
                        <a class="info" href="mailto:{{ $footerInfo->email }}"><i class="fas fa-envelope"></i>{{ $footerInfo->email }}</a>
                        @endif
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="fp__footer_bottom_text d-flex flex-wrap justify-content-between">
                        @if(isset($footerInfo) && $footerInfo && $footerInfo->copyright)

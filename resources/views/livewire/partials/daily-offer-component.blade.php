    ...
    <div class="container">
        ...
        <div class="row offer_item_slider wow fadeInUp" data-wow-duration="1s">
            @foreach ($dailyOffers as $dailyOffer)
                <div class="col-xl-4" wire:key="{{ $dailyOffer->id }}">
                    <div class="fp__offer_item_single">
                        ...
                        <div class="text">
                            ...
                            <ul class="d-flex flex-wrap">
                                <li><a href="javascript:;" class="call-product-daily" data-product-id="{{ $dailyOffer->product->id }}"><i
    ...
    document.addEventListener('DOMContentLoaded', function () {
        document.addEventListener('click', function (event) {
            if (event.target.closest('.call-product-daily')) {
                ...
                Livewire.emit('productDaily', productId);
            }
        });
    });
</script>

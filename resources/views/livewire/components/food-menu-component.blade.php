...
{{--                            x-on:click="name = '{{$product->name}}'"--}}
                            <ul class="d-flex flex-wrap justify-content-center">
                                <li><button  data-bs-toggle="modal" data-bs-target="#cartModal{{$product->id}}"  ><i class="fas fa-shopping-basket"></i></button></li>
                    ...
                    <div wire:ignore class="fp__cart_popup">
                        <div class="modal fade" id="cartModal{{$product->id}}" tabindex="-1" role="dialog" aria-labelledby="productModalLabel" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    <div class="modal-body">
                                        ...
                                        <div class="fp__cart_popup_text" x-data="{sum:0}">
                                            ...
                                            <h4 class="price">{{ $product->offer_price }}<del>{{ $product->price }} </h4>

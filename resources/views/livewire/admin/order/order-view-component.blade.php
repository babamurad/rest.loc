    ...
    <div class="section-body">
        <div class="invoice">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <address>
                                    ...
                                    <strong>{{ __('Name:') }}</strong> {{ $order->address->first_name }} {{ $order->address->last_name }} <br>
                                    <strong>{{ __('Phone:') }} {{ $order->address->phone }}</strong><br>
                                    <strong>{{ __('Address:') }}{{ $order->address->address }}</strong><br>
                                    <strong>{{ __('Area:') }} {{ $order->address->deliveryArea->area_name }}
                                    </strong>
                                </address>
                            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-hover table-md">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            <li><span>{{ __('Size:') }} {{ @json_decode($item->product_size)->name }}</span>
            ...
            <div class="text-md-right">
                ...
                <button id="action-print" class="btn btn-warning btn-icon icon-left"><i class="fas fa-print"></i> {{ __('Print') }}</button>
            </div>
        </div>
    </div>
    <style>

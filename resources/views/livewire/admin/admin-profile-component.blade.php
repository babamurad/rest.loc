                    ...
                    <div class="card-body">
                        <form >
                            ...
                            <div class="form-group mb-4">
                                <label class="col-form-label text-md-right">{{ __('Profile Image') }}</label>
                                <div class="row">
                            ...
                            <button type="button" class="btn btn-primary" wire:click.prevent="updateUser">{{ __('Save') }}</button>
                        </form>
                    </div>
                </div>
            </div>
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <form action="">
                            ...
                            <button type="button" class="btn btn-primary" wire:click="updatePassword">{{ __('Save') }}</button>
                        </form>
                    </div>
                </div>
            </div>

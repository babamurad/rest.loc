<section class="fp__menu mt_95 xs_mt_65"
         x-data="{ showModal: false, product: null }"

    {{--         x-data="{ showModal: false, selectedId: null, image : '', price : 0, offer_price : 0, }"--}}
>
    ...
    <div>
        ...
        <div x-show="showModal"
             ...
             :class="showModal ? 'd-block show' : 'd-none'"
             class="modal fade"
             tabindex="-1"
             role="dialog"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content" @click.outside="showModal = false">
                    <div class="modal-header">
                        <h5 class="modal-title">Детали продукта (ID: <span x-text="product.name"></span>)</h5>
                        <button type="button" class="close" @click="showModal = false" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <div class="img-fluid"><img :src="product.thumb_image" alt=""></div>
                        <!-- Отображение размеров (sizes) -->
                        <h6>Размеры:</h6>
                        <ul>
                        ...
                        <div class="fp__menu_item_text">
                            ...
                            <ul class="d-flex flex-wrap justify-content-center">
                                ...
                                <button
                                    ...
                                    @key="{{ $product->id }}"
                                    @click="showModal = true; product = @json($product)"
